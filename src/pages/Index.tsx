    ...
    <div className="min-h-screen bg-background text-foreground font-sans">
      ...
      <div className="relative" style={{ height: "100vh" }}>
        <section className="sticky top-0 h-screen w-full overflow-hidden rounded-b-3xl">
          ...
          />
          <div className="relative mx-auto grid h-full max-w-[1400px] items-end gap-10 px-6 pb-[95px] text-center md:items-center md:pb-0 md:pt-0 md:text-left lg:grid-cols-2 lg:px-10">
